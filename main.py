...
UNLOCK_CODE = "VodyXxvfmdio53453ealgrdj"  # Le code pour débloquer
...
PAUSE_VIDEO = "333 776"
LIKE_BUTTON = "993 1450"
FOLLOW_BUTTON = "350 780"
SWIPE_REFRESH = "820 520 820 1075 820"
...
class TikTokTaskBot:
    ...
    def update_script(self):
        ...
        url = "https://raw.githubusercontent.com/MichelPrincy/faniry/main/main.py"
        try:
    ...
    async def do_task(self, account_idx, link, action):
        try:
            self.cleanup_apps()
            coord_clone = APP_CHOOSER.get(account_idx, "100 1770")
